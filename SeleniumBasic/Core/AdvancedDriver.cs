...
public class AdvancedDriver
{
    ...
    public IWebDriver GetChromeDriver()
    {
        ...
        return new ChromeDriver(_path + @"/Resources/", chromeOptions);
    }

    public IWebDriver GetFirefoxDriver()
    {
        const string mimeTypes = "image/png,image/gif,image/jpeg,image/pjpeg,application/pdf,text/csv,application/vnd.ms-excel," +
